...
game::State GameScene::getCurrentGameState() const{return m_game.STATE;}
QGraphicsPixmapItem* GameScene::getFishItem() const{return m_fishItem;}
int GameScene::getFishXpos() const { return m_fishXpos; }
int GameScene::getFishYpos() const { return m_fishYpos; }
